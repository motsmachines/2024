...
<li>9h30 Jaap Kamps, faculty of humanities of University of Amsterdam        
        <Détails style="margin-left:50px"><summary> détails </summary>
                <b>Résumé:</b> <br> En science, la créativité et la création sont généralement considérées comme l'opposé de la rigueur scientifique. Le contexte de la justification scientifique est caractérisé par des règles très strictes, guidées par une logique formelle et une méthodologie rigoureuse.  Le contexte de la recherche, en revanche, est beaucoup plus libre : il est même préférable de le laisser à la psychologie, selon l'éminent philosophe Karl Popper.  Là où la logique dominait l'intelligence artificielle (IA) classique, les progrès révolutionnaires récents concernent les modèles d'IA qui excellent dans la génération, la création et la créativité. Quel est le rôle de ces modèles d'IA dans la recherche scientifique ? Quels sont les points forts et les difficultés de ces modèles dans ce contexte, étant donné qu'ils sont connus pour "halluciner" et présenter des biais de confirmation ? Alors que les modèles précédents se concentraient sur le contexte de la justification scientifique, ces modèles peuvent-ils jouer un rôle dans le contexte de la découverte scientifique ? Et comment cela change-t-il le rôle et la répartition des tâches entre le chercheur humain et l'assistant des modèles d'IA ?
                <br><br><b>Biographie :</b><br>
Jaap Kamps a obtenu un doctorat en intelligence artificielle "logique" à l'université d'Amsterdam.  Il est cofondateur du groupe de recherche d'information (RI) et du groupe de traitement du langage naturel (NLP) de l'université d'Amsterdam.  Il a travaillé sur un large éventail de sujets allant de la recherche d'information centrée sur l'utilisateur à la recherche d'information centrée sur le système, y compris des travaux pionniers sur la recherche de documents structurés et sur le classement neuronal.  Il a travaillé sur de nombreux domaines du NLP, notamment sur l'analyse des sentiments, la modélisation du langage et la génération de texte.  Il s'intéresse actuellement à "l'IA pour le bien social" en travaillant sur de nouveaux outils d'accès au patrimoine culturel et aux données politiques, et en développant des modèles neuronaux explicables et interprétables pour la recherche et la recommandation, ainsi que des moyens d'ouvrir les articles scientifiques et les informations gouvernementales aux profanes, aux citoyens et aux journalistes.
</Détails> </li>
